    ...
    <div style="float: left">
        <form class="form-inline" action="${pageContext.request.contextPath}/FindUserByPageServlet" method="post">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" value="${condition.email[0]}" class="form-control" id="exampleInputEmail2"style="width: 120px">
            </div>
    ...
    <form id="form" action="${pageContext.request.contextPath}/delSelectedServlet" method="post">
        <table border="1" class="table table-bordered table-hover table2excel">
            ...
            <c:forEach items="${pageBean.list}" var="flower" varStatus="s">
                <tr  >
                    <td class="noExl" ><input type="checkbox" name="uid" value="${flower.fid}" ></td>
                    <td style="text-align: center;margin:0 auto">${flower.fid}</td>
                    <td><img src="${pageContext.request.contextPath}/${flower.flowerImage.image}"
...
<%--                    </c:if>--%>
                    <td>${flower.remark}</td>
                    <td>${flower.number}</td>
                    <td>${flower.vipFprice}</td>
                    <td class="noExl">
                        <a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/finduserServlet?id=${flower.fid}">修改</a>&nbsp;
                        <a class="btn btn-default btn-sm" href="/manageFlower/upFlower?Fid=${flower.fid}">上架</a></td>
                </tr>
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <li>
                    ...
                    <a href="/manageFlower/dropflowerList?infos=&CurrentPage=${pageBean.currentPage - 1}" aria-label="Previous">
                ...
                <c:forEach begin="1" end="${pageBean.totalPage}" var="i" >
                    ...
                    <c:if test="${pageBean.currentPage == i}">
                        <li class="active"><a href="/manageFlower/dropflowerList?infos=&CurrentPage=${i}">${i}</a></li>
                    </c:if>
                    <c:if test="${pageBean.currentPage != i}">
                        <li><a href="/manageFlower/dropflowerList?infos=&CurrentPage=${i} ">${i}</a></li>
                    </c:if>
                ...
                <li >
                    ...
                    <a href="/manageFlower/dropflowerList?infos=&CurrentPage=${pageBean.currentPage + 1} " aria-label="Next">
