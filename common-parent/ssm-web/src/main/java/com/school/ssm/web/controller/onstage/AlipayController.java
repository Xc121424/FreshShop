...
import com.school.ssm.web.controller.utils.LeeJSONResult;
...
//		ModelAndView mv = new ModelAndView("jsp/products");
...
//
//		ModelAndView mv = new ModelAndView("jsp/goConfirm");
//		mv.addObject("p", p);
//
//		return mv;
//	}
...
//
//		ModelAndView mv = new ModelAndView("jsp/goPay");
...
//
//		ModelAndView mv = new ModelAndView("jsp/alipaySuccess");
//		//——请在这里编写您的程序（以下代码仅作参考）——
//		if(signVerified) {
//			//商户订单号
